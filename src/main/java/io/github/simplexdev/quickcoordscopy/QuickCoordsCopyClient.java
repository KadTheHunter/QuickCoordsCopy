        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (copyCoordsKey.consumeClick()) {
                if (client.player != null) {
                    copyCoordinates(client, QuickCoordsCopyConfig.copyFormat);
                }
            }
            
            while (secondaryCopyCoordsKey.consumeClick()) {
                if (client.player != null) {
                    copyCoordinates(client, QuickCoordsCopyConfig.secondaryCopyFormat);
                }
            }
        });
    }
    
    private static void copyCoordinates(Minecraft client, String format) {
